package test.com.fg.CustomView;
...
import test.com.fg.activity.Login;
import test.com.fg.activity.UserActivity;
...
public class TitleView extends RelativeLayout {
     ...
     * @param typeArray TypedArray
     */
    private void initRightImageView (final Context context, TypedArray typeArray) {
        ...
        mRightImageIv.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                @SuppressLint("WorldReadableFiles")
                SharedPreferences user = context.getSharedPreferences("user",0);
                if("".equals(user.getString("email",""))){
